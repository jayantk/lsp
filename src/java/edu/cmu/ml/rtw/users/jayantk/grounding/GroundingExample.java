...
public class GroundingExample implements Serializable {
  ...
  // Annotations added later for vector space stuff.
  private final SExpression cfgParse;
  private final Expression autogeneratedLogicalForm;
   ...
   * @param cfgParse
   * @param autogeneratedLogicalForm
   */
    public GroundingExample(List<List<String>> words, double[] wordScores,Tensor groundingTensor,
			    String domainName, int curriculumLevel, Expression logicalForm, SExpression cfgParse,
			    Expression autogeneratedLogicalForm) {
    this.words = words;
    ...
    this.cfgParse = cfgParse;
    this.autogeneratedLogicalForm = autogeneratedLogicalForm;
  }
   ...
   */
    ...
    this.cfgParse = null;
    this.autogeneratedLogicalForm = null;
  }
  ...
  public SExpression getCfgParse() {
    return cfgParse;
  }
  
  public Expression getAutogeneratedLogicalForm() {
    return autogeneratedLogicalForm;
  }
